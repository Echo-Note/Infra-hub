...
class UserInfo(AutoCleanFileMixin, DbAuditModel, AbstractUser, ModeTypeAbstract):
    ...
    roles = models.ManyToManyField(to="apps.system.UserRole", verbose_name=_("Role permission"), blank=True)
    rules = models.ManyToManyField(to="apps.system.DataPermission", verbose_name=_("Data permission"), blank=True)
    dept = models.ForeignKey(to="apps.system.DeptInfo", verbose_name=_("Department"), on_delete=models.PROTECT, blank=True,
