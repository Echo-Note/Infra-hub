...
from apps.settings.utils.security import LoginIpBlockUtil, SendVerifyCodeBlockUtil
from apps.system.models import UserInfo
from apps.system.utils.auth import check_is_block, check_token_and_captcha
...
class SendVerifyCodeAPIView(GenericAPIView):
    ...
    def prepare_code_data(username):
        ...
        context = {"username": username, "title": subject, "code": code, "ttl": settings.VERIFY_CODE_TTL}
        message = render_to_string("../../templates/msg_verify_code.html", context)
